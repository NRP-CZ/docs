...
<Cards>
  <Card title="Branding" arrow href="/customize/branding/theme">
    Change site name, brand logo, color palette, fonts and styling.
  </Card>
  <Card title="Custom fields" arrow href="/customize/record/custom_fields">
    Add custom metadata fields to your records.
  </Card>
  <Card title="Vocabularies" arrow href="/customize/vocabularies/initial_data">
  ...
  <Card title="Search results" arrow href="/customize/record/search">
    Modify how to display the results of a record search.
  </Card>
  <Card title="Record deposition" arrow href="/customize/record/deposit">
...
<Cards>
  <Card title="Overriding UI components" arrow href="/customize/overriding">
    Overriding UI components for customization.
  </Card>
  ...
  <Card
    title="Editable vocabularies"
    arrow
    href="/customize/vocabularies/editable"
  >
    Allow people create new vocabulary items.
  </Card>
  <Card title="Create record model" arrow href="/customize/record/new_model">
    Create additional custom record metadata model.
  </Card>
  <Card
    title="Complex custom fields"
    arrow
    href="/customize/record/complex_fields"
  >
  ...
  <Card
    ...
    arrow
    href="/customize/record/complex_validation"
  >
