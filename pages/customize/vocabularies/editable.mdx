...
If you need to specify non-string variables, you can use the `custom_fields` field which contain the names
of the extra variables. See [Vocabulary custom fields](/customize/vocabularies/custom_fields.mdx) for more information.
