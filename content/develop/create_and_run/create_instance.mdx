...
Refer to the [Getting started](/get_started) guide to verify that you have all the prerequisites installed.
...
See the [export customization guide](../model/exports_and_imports) for more information.

## Install and run the repository

To install and run the repository, follow the instructions in the [running an instance guide](./develop/run_instance#install-the-backend-and-build-the-frontend).
