...
<!-- TODO: Verify if --set +variable syntax works for appending to variables -->
...
<!-- TODO: Update this section - actual signature is: nrp-cmd create request REQUEST_TYPE_ID RECORD_ID [VARIABLE] [--submit]
     The order is different: type_id comes first, then record_id, then optional variable name as positional arg (not @variable).
     The metadata parameter doesn't appear in the actual help. Need to verify if this section needs rewrite. -->
...
<!-- TODO: Verify this section - actual help doesn't show update request command. Need to check if this is implemented. -->
...
<!-- TODO: Verify if --set option exists for update request command -->
