# CESNET Invenio repository python client
...
You can find the demo code for both synchronous and asynchronous clients in the [nrp-cmd GitHub repository](https://github.com/NRP-CZ/nrp-cmd/tree/main/docs).
...
- [Sync Client Overview](python_library/sync_library) - Getting started with the synchronous API
- [Records API](python_library/sync_library_records) - Create, read, update, delete, and search records
- [Files API](python_library/sync_library_files) - Upload, download, and manage file attachments
- [Requests API](python_library/sync_library_requests) - Handle workflows, approvals, and lifecycle operations

### Asynchronous Client

- [Async Client Overview](python_library/async_library) - Getting started with the async/await API
- [Records API](python_library/async_library_records) - Asynchronously manage records with full examples
- [Files API](python_library/async_library_files) - Concurrent file operations and streaming
- [Requests API](python_library/async_library_requests) - Async workflow and approval management
