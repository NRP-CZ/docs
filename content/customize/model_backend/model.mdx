...
For a complete list of metadata field types, see the [metadata reference](./model_reference.md).
...
**Note:** After adding custom metadata fields in `metadata.yaml`, you must also configure the deposit form UI to display and edit these fields. See the [deposit form customization documentation](../model_ui/deposit.mdx) for details.
