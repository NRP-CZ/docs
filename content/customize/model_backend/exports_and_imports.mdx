...
1. Inherit from `MarshmallowSerializer` and provide a different format serializer class (for example, `XMLSerializer`) - see [flask-resources](https://github.com/inveniosoftware/flask-resources/tree/master/flask_resources/serializers) for more details.
