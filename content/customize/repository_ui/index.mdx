...
| Client-side | **JavaScript**     | Interactive components, forms, and dynamic UI (vanilla JS or React) |
...
<Cards>
  ...
  <Card title="React Components" arrow href="/customize/repository_ui/js_assets/react">
