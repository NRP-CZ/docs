...
JinjaX components are rendered through the [UI Resource architecture](/customize/repository_ui/resources) that connects backend data with frontend templates. When a UI Resource view method is called, it uses the oarepo-ui catalog to render JinjaX components with the appropriate context data.
...
```jsx copy filename="templates/products/Products.jinja"
...
<Cards>
    <Card title="Official JinjaX Documentation" href="https://jinjax.scaletti.dev/guide/">
        Complete reference for JinjaX syntax and features.
    </Card>
    <Card title="oarepo-ui JinjaX catalog" href="https://github.com/oarepo/oarepo-ui/blob/main/oarepo_ui/templating/catalog.py">
        Implementation of the JinjaX catalog in oarepo-ui.
    </Card>
</Cards>
