...
In this page we will focus on creation and usage of custom Jinja templates including how to use them, how templates interact with [UI Resources](/customize/repository_ui/resources) (the CESNET Invenio mechanism for generating HTML responses for front-end pages).
