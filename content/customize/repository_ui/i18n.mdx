...
CESNET Invenio repositories support full internationalization (i18n) across **Python backend**, **Jinja templates**, and **React front-end**.
...
CESNET Invenio repositories support multilingual UI by combining:
