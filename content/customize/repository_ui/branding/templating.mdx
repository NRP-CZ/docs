...
## Understanding Template Layers in CESNET Invenio Repositories
...
This method allows you to override basically any template used in your site.
...
This just scratches the surface of what you can achieve with templating in CESNET Invenio repositories. For a more in-depth Jinja template development
reference, please head over to the [Jinja templates](/customize/repository_ui/templating/jinja) section.