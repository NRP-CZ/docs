...
color schemes, typography, spacing, shapes, shadows, and more. It lets you change the built-in themes to better match your institution's branding guidelines.

## Prerequisites

Before proceeding, ensure you are familiar with:

- **[CSS](https://developer.mozilla.org/en-US/docs/Web/CSS)** — the core styling language of the web.
- **[LESS](https://lesscss.org/)** — a CSS preprocessor adding variables, nesting, mixins, and more.


<Callout type="warning" emoji="⚠️">Any changes made to files mentioned in this docs require running a [development server with assets watcher](/installation/run_instance#run-frontend-assets-builder-optional) for changes to take effect.</Callout>
...
You can also define your own variables here and use them later in your custom styling rules.
