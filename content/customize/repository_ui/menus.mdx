...
You can **add new submenus** (register them programmatically) or **modify properties of existing submenus** via instance configuration. Menu customization in CESNET Invenio repositories
...
In CESNET Invenio repositories, there might be a few more, depending on your record models & enabled set of features.
