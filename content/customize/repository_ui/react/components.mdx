...
```jsx
import { EDTFSingleDatePicker, EDTFDaterangePicker } from "@js/oarepo_ui/forms";
...
import { TextField, StringArrayField, EDTFDaterangePicker } from "@js/oarepo_ui/forms";
      ...
      {({ indexPath }) => {
        ...
        return (
          <>
            ...
            <EDTFDaterangePicker fieldPath={`${prefix}.eventDate`} />
            <GroupField>
