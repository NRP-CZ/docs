...
If you are more interested in how to change built-in templates with your custom ones, the topic is covered in great detail undder the [Branding -> Templating](/customize/repository_ui/branding/templating) docs
...
in a Jinja templates. Please refer to the official [Jinja Template Designer](https://jinja.palletsprojects.com/en/stable/templates/)
