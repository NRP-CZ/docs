...
<Cards>
    <Cards.Card title='Create workflow' arrow href="/customize/workflows/create">Define workflows inside an invenio.cfg file.</Cards.Card>
    <Cards.Card title='Apply workflow' arrow href="/customize/workflows/apply">Select which workflow is default for a community.</Cards.Card>
    <Cards.Card title='Develop new requests' arrow href="/develop/workflows">Develop new requests.</Cards.Card>
</Cards>
