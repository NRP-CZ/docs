...
All vocabularies in your repository are accessible at runtime through the REST API
(`/api/vocabularies`) and the user interface (`/vocabularies`).

<Cards>
    <Card title='Standard vocabularies' arrow href="https://github.com/inveniosoftware/invenio-rdm-records/tree/master/invenio_rdm_records/fixtures/data/vocabularies">Browse all built-in Invenio RDM vocabularies.</Card>
    ...
    <Card title='External vocabularies' arrow href="/customize/vocabularies/external">Integrate external vocabularies not managed inside the repository.</Card>
</Cards>
