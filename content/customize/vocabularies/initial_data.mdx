...
## Speeding up the initial data loading

For development purposes, you might want to speed up the initial data loading by reducing
the number of vocabularies being loaded. You can do so by modifying the
`app_data/vocabularies.yaml` file to only include the vocabularies you need.
