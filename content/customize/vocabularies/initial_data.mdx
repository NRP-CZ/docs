...
The vocabularies not listed in the catalogue will be loaded from the default Invenio RDM vocabularies package (see [standard vocabularies reference](https://github.com/inveniosoftware/invenio-rdm-records/tree/master/invenio_rdm_records/fixtures/data/vocabularies)).
...
- [Standard controlled vocabularies reference](https://github.com/inveniosoftware/invenio-rdm-records/tree/master/invenio_rdm_records/fixtures/data/vocabularies)