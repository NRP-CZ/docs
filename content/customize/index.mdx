...
NRP (National Repository Platform) builds upon [InvenioRDM](https://inveniordm.docs.cern.ch/) software and extends it to support **repositories with completely custom metadata models, deposit forms, and record detail pages** — all within a shared platform.
...
<Cards>
  <Card title='⚙️ Site settings' arrow href="/customize/configure">
    Change site name, description, default language, feature toggles, and other global application-wide settings.
  </Card>
  <Card title='🎨 Branding & Theme' arrow href="/customize/repository_ui/branding/theme">
    Change overall repository styling like typography, color palette, logo, base page layout, and copywriting.
  </Card>
  <Card title='📄 Pages & templates' arrow href="/customize/repository_ui/branding/templating">
  ...
  <Card title='⚛️ JavaScript & React components' arrow href="/customize/repository_ui/js_assets">
    Add interactivity using vanilla JavaScript or replace default React components with your own components.
  </Card>
  <Card title='🌍 Internationalization' arrow href="/customize/repository_ui/i18n">
  ...
  <Card title='📊 Initial data' arrow href="/customize/vocabularies/initial_data">
