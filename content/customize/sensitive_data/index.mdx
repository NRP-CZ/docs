...
Then the encrypted file is uploaded to the repository as usual. The repository will perform a quick check that
the file is encrypted using the CRYPT4GH format and that the repository can read and decode the headers of the file.
