...
```jinja filename="ui/mymodel/templates/semantic-ui/mymodel/RecordSearch.jinja"
...
```jinja filename="ui/mymodel/templates/semantic-ui/mymodel/record_search/javascript.html"
<script>
