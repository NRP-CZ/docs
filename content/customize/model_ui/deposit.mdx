...
### Tune Preset Sections with Overrides
...
### The Wizard Form Layout

The form is rendered as a wizard with vertical tabs — the copier-generated entry point already passes `useWizardForm` together with the `sections` array (see [Build Your Form from Sections](#build-your-form-from-sections)). A minimal setup looks like this:
