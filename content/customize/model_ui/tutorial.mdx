...
> **Tip:** For JavaScript file changes (deposit form, search result), run the assets watcher in a separate terminal to automatically rebuild on file changes:
> ```bash
...
Visit the deposit page at `https://127.0.0.1:5000/mymodel/deposit/new`
