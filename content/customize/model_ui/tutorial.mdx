...
|-----------|---------|--------------|----------------|
| **Record detail** | Displays individual record | `templates/semantic-ui/{{model_name}}/record_detail/main.html` | [Record landing page](/customize/model_ui/detail) |
...
Edit `templates/semantic-ui/{{model_name}}/record_detail/main.html`:

```html filename="templates/semantic-ui/{{model_name}}/record_detail/main.html"
...
| Block | Purpose |
|-------|---------|
| `record_header` | Page header area |
| `record_header_info` | Custom info below header |
| `record_sidebar` | Right sidebar content (add to `side_bar/` directory) |
| `banner_draft_header` | Draft warning banner (in `banners.html`) |
