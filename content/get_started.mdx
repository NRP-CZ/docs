...
You need to add at least a datacite export for you new model. This is required not only for DOI registration, but also for other parts of Invenio, such as tombstone page when a record is deleted, proper citation generation and signposting headers.
See the [export customization guide](./develop/exports) for more information.
