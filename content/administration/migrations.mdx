...
<MigrationHeader
  date="2026-07-13"
  title="oarepo-app 6.2.0 → 6.3.0"
  versionBadge="oarepo-app ≥ 6.3.0"
/>
...
- If you use other symbols from `oarepo.config`, also migrate them to `oarepo_config` - for example: `from oarepo_config import load_configuration_variables`
...
See [simplified workflows](/customize/workflows/simplified) for a more streamlined approach to workflow configuration.
