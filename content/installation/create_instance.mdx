...
If you have already set up your services, after creating a new model you will need to [reinitialize the database and indices](/customize/model_backend/db_update).
</Callout>
